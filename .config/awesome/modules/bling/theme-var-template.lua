...
theme.tabbar_bg_normal = "#1e1e2e" -- background color of the focused client on the tabbar
theme.tabbar_fg_normal = "#cdd6f4" -- foreground color of the focused client on the tabbar
theme.tabbar_bg_focus = "#313244" -- background color of unfocused clients on the tabbar
theme.tabbar_fg_focus = "#f38ba8" -- foreground color of unfocused clients on the tabbar
...
theme.tabbar_color_close = "#f38ba8" -- changes the color of the close button
theme.tabbar_color_min = "#f9e2af" -- changes the color of the minimize button
theme.tabbar_color_float = "#cba6f7" -- changes the color of the float button
...
theme.tag_preview_client_bg = "#1e1e2e" -- The bg color of each client
theme.tag_preview_client_border_color = "#cdd6f4" -- The border color of each client
theme.tag_preview_client_border_width = 3 -- The border width of each client
theme.tag_preview_widget_bg = "#1e1e2e" -- The bg color of the widget
theme.tag_preview_widget_border_color = "#cdd6f4" -- The border color of the widget
...
theme.task_preview_widget_bg = "#1e1e2e" -- The bg color of the widget
theme.task_preview_widget_border_color = "#cdd6f4" -- The border color of the widget
...
-- window switcher
theme.window_switcher_widget_bg = "#1e1e2e" -- The bg color of the widget
...
theme.window_switcher_widget_border_color = "#cdd6f4" -- The border color of the widget
...
theme.window_switcher_name_normal_color = "#cdd6f4" -- The color of one title if the client is unfocused
theme.window_switcher_name_focus_color = "#f38ba8" -- The color of one title if the client is focused
